    ...
    ui.row(row_id)
        ...
        .content(|ui| {
            ...
            ui.text(status_id)
                ...
                .font_size(13.0)
                .line_height(20.0)
                .horizontal_align(sky_engine::ui::neo::HorizontalAlign::Right)
...
fn main() {
    ...
    world
        .install(
            WindowPlugin::new("Neo Scroll Column Demo", WINDOW_W, WINDOW_H)
                .with_vsync(false)
                .with_resizable(true),
        )
        .unwrap();
    ...
    App::new(world).run(NeoScrollColumnDemo::default());
}
