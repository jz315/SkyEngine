...
//!
//! ```bash
//! cargo run --example ui_serein_scroll_x --features ui-serein --release
//! ```
...
use sky_engine::ui::serein::{widgets, Align, Color, Size, State};

const WINDOW_W: u32 = 980;
const WINDOW_H: u32 = 520;

struct SereinScrollXDemo {
...
impl Default for SereinScrollXDemo {
    fn default() -> Self {
        Self {
...
impl AppState for SereinScrollXDemo {
...
fn feature_card(ui: &mut sky_engine::ui::serein::Ui, index: usize) {
...
fn main() {
    ...
    world
        .install(
            WindowPlugin::new("Serein Scroll X Demo", WINDOW_W, WINDOW_H)
                .with_vsync(false)
                .with_resizable(true),
        )
        .unwrap();
    ...
    App::new(world).run(SereinScrollXDemo::default());
}
