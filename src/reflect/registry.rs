...
///
/// This is the thin reflection layer used by the ECS for component layout and
/// drop semantics. Inspector metadata is represented separately by
/// [`ReflectType`].
...
/// Static layout metadata for one registered Rust/dynamic type.
#[derive(Debug)]
pub struct TypeInfo {
    pub size: usize,
    pub align: usize,
...
/// Registers a dynamic opaque type by name/layout.
...
/// ECS-facing semantic aliases. They still live on the reflect foundation.
