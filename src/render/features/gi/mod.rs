...
pub(crate) use frame_extension::GiFrameExtension;
pub use passes::{GiCompositePass, GiUpdateCompute};

use crate::render::pipeline::{RenderFeature, RenderPipelineBuilder};

/// Installs the provider-driven global-illumination frame adapter.
pub struct GiFeature;

impl RenderFeature for GiFeature {
    ...
    fn register(&mut self, builder: &mut RenderPipelineBuilder) {
        ...
        *builder = current.add_frame_extension(GiFrameExtension::default());
    }
}
...
use crate::math::Mat4;
pub use crate::render::core::scene::indirect_lighting::{
    IndirectLightingProviderConfig as GiProviderConfig, IndirectLightingSettings as GiSettings,
};
...
pub use crate::render::resources::{
    IndirectLightingSampling as GiSamplingBinding, IndirectLightingShader as GiShaderDescriptor,
    NULL_INDIRECT_LIGHTING_SHADER as NULL_GI_SHADER,
};
