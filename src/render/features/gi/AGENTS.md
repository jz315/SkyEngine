# AGENTS.md - `src/render/features/gi`
...
+-- providers/
    ...
    +-- ddgi/       - DDGI provider split into provider/resources/BVH/prepare/execute/tests
...
- When changing GI behavior, check both:
  ...
  - runtime step ordering in `passes.rs` and `src/render/core/execution/step_nodes/phase_step_node.rs`.
