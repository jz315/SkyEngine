...
use crate::render::features::tilemap::{TileId, TilemapHandle};
...
mod tests {
    ...
    use crate::render::features::tilemap::TilemapHandle;
    ...
    fn tileset_grid_uses_texture_pixel_size_for_uvs() {
        ...
        let uv = grid
            .uv_rect(crate::render::features::tilemap::TileId(71))
            .unwrap();
    ...
    fn tileset_grid_applies_tiled_margin_and_spacing_to_uvs() {
        ...
        let uv = grid
            .uv_rect(crate::render::features::tilemap::TileId(9))
            .unwrap();
    ...
    fn tileset_grid_maps_animated_tile_by_elapsed_time() {
        let grid = TilesetGrid::new(Handle::<TextureAsset>::new(AssetId::new()), [16, 16], 4, 1)
            .animations([TileAnimation::new(
                crate::render::features::tilemap::TileId(1),
                [
                    TileAnimationFrame::new(crate::render::features::tilemap::TileId(1), 100),
                    TileAnimationFrame::new(crate::render::features::tilemap::TileId(2), 100),
                    TileAnimationFrame::new(crate::render::features::tilemap::TileId(3), 200),
                ],
            )]);

        assert_eq!(
            grid.animated_tile_id(crate::render::features::tilemap::TileId(1), 0.05),
            crate::render::features::tilemap::TileId(1)
        );
        assert_eq!(
            grid.animated_tile_id(crate::render::features::tilemap::TileId(1), 0.15),
            crate::render::features::tilemap::TileId(2)
        );
        assert_eq!(
            grid.animated_tile_id(crate::render::features::tilemap::TileId(1), 0.30),
            crate::render::features::tilemap::TileId(3)
        );
        assert_eq!(
            grid.animated_tile_id(crate::render::features::tilemap::TileId(1), 0.45),
            crate::render::features::tilemap::TileId(1)
        );
        assert_ne!(
