...
use crate::render::{DirectionalLight, PointLight, SpotLight, Transform};

pub(crate) fn collect_gpu_lights_into(
    world: &World,
...
fn collect_gpu_lights(
    ...
    collect_gpu_lights_into(world, transforms, &mut lights);
    lights
}
...
mod tests {
    ...
    use crate::render::{DirectionalLight, PointLight, SpotLight};
