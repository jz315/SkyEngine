...
mod tests {
    ...
    use crate::render::{
        CameraMarker, DirectionalLight, MeshRenderer, Parent, PointLight, RenderSettings,
        SpotLight, Transform,
    };
    ...
    fn scene_snapshot_extracts_neutral_3d_scene() {
        ...
        let mesh_instance = snapshot
            .mesh_instance(mesh_entity)
            .expect("mesh instance should be synced");
        let first_materials_ptr = mesh_instance.materials.as_ptr();
        ...
        assert_eq!(
            snapshot
                ...
                .as_ptr(),
            first_materials_ptr,
            "snapshot extraction should reuse per-instance material storage"
        );
