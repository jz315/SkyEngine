...
impl MeshVertexSemantic {
    pub(crate) const fn to_wgpu(self) -> crate::render::expert::resources::VertexSemantic {
        match self {
            Self::Position => crate::render::expert::resources::VertexSemantic::Position,
            Self::Normal => crate::render::expert::resources::VertexSemantic::Normal,
            Self::Tangent => crate::render::expert::resources::VertexSemantic::Tangent,
            Self::UV0 => crate::render::expert::resources::VertexSemantic::UV0,
            Self::UV1 => crate::render::expert::resources::VertexSemantic::UV1,
            Self::Color => crate::render::expert::resources::VertexSemantic::Color,
            Self::Custom(value) => crate::render::expert::resources::VertexSemantic::Custom(value),
        }
    }
}
...
impl MeshVertexLayout {
    ...
    pub(crate) fn to_wgpu(&self) -> crate::render::expert::resources::VertexLayout {
        crate::render::expert::resources::VertexLayout::new(
            self.stride,
            self.attributes
                .iter()
                .map(|attribute| {
                    crate::render::expert::resources::VertexAttribute::new(
