...
use crate::render::component::{
    RenderLayerMask, SortingLayer, TilemapDepthSort, TilemapOrientation, TilemapRenderOrder,
...
mod tests {
    ...
    fn orthogonal_chunk_order_matches_tiled_render_order() {
        let map = Tilemap::new(crate::render::tilemap::TilemapDescriptor::new(64, 64, 1));
