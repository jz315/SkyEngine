...
use crate::render::execution::{
    ComputeStepNode, FramePipeline, FramePipelineCache, FrameViewNode, GraphPassStepNode,
    HeadlessKeepAliveNode, PhaseState, PhaseStepNode, PostFxStepNode, PreparedFrame, PreparedView,
    RenderPassStepNode, RuntimeRenderServices, SceneColorSeedNode, ViewExecutionContext,
};
...
pub(crate) fn build_runtime_pipeline<'a>(
    ...
    let mut pipeline = FramePipeline::with_cache(cache);
