...
use crate::render::resources::{IndirectLightingSampling, SceneShadowResources};
...
pub struct DrawContext<'ctx, 'pass, 'tex> {
    ...
    pub(super) gi_sampling: Option<IndirectLightingSampling>,
...
impl<'ctx, 'pass, 'tex> DrawContext<'ctx, 'pass, 'tex> {
    ...
    pub(crate) fn new(
        ...
        gi_sampling: Option<IndirectLightingSampling>,
