...
pub struct RenderPipelineBuilder {
    ...
    pub(super) frame_extensions: Vec<Box<dyn FrameExtension>>,
...
impl RenderPipelineBuilder {
    ...
    pub(crate) fn add_frame_extension<E>(mut self, extension: E) -> Self
    where
        E: FrameExtension + 'static,
    {
        self.frame_extensions.push(Box::new(extension));
        self
    }
