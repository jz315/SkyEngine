...
- `VnPlugin`: installs the core runtime resources into an ECS `World`.
- `VnUiState`, `VnPreferences`, `VnCommandRegistry`, and marker components for later presentation binding.
