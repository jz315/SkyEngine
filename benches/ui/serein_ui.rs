...
#[path = "../../examples/ui/serein/control_center/actions.rs"]
mod actions;
#[allow(dead_code)]
#[path = "../../examples/ui/serein/control_center/locale.rs"]
mod locale;
#[path = "../../examples/ui/serein/control_center/model.rs"]
mod model;
#[path = "../../examples/ui/serein/control_center/theme.rs"]
mod theme;
#[path = "../../examples/ui/serein/control_center/view/mod.rs"]
mod view;
...
fn render_row(ui: &mut sky_engine::ui::serein::Ui, index: usize, height: f32) {
...
fn bench_serein_ui_lists(c: &mut Criterion) {
    let mut group = c.benchmark_group("serein_ui_list");
...
fn bench_serein_ui_common_controls(c: &mut Criterion) {
    let mut group = c.benchmark_group("serein_ui_common_controls");
    group.sample_size(10);
    group.warm_up_time(Duration::from_millis(500));
    group.measurement_time(Duration::from_secs(2));
...
fn bench_serein_ui_control_center(c: &mut Criterion) {
    let mut group = c.benchmark_group("serein_ui_control_center_real");
    group.sample_size(10);
    group.warm_up_time(Duration::from_millis(500));
    group.measurement_time(Duration::from_secs(2));
...
fn bench_serein_ui_motion(c: &mut Criterion) {
    let mut group = c.benchmark_group("serein_ui_motion");
    group.sample_size(10);
    group.warm_up_time(Duration::from_millis(500));
    group.measurement_time(Duration::from_secs(2));
...
criterion_group!(
    serein_ui_benches,
    bench_serein_ui_lists,
    bench_serein_ui_common_controls,
    bench_serein_ui_control_center,
    bench_serein_ui_motion
);
criterion_main!(serein_ui_benches);
